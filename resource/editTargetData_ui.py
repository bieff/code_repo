...
# Form implementation generated from reading ui file 'editTargetData.ui'
#
...
"}")
        ...
        self.pushButton.clicked.connect(Form.edit_target_table)
        self.pushButton_2.clicked.connect(Form.cancel_edit_target_table)
        QtCore.QMetaObject.connectSlotsByName(Form)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "靶点表"))
        self.label.setText(_translate("Form", "药物名称："))
        self.label_2.setText(_translate("Form", "英文名称："))
